...
export const INTENT_DEFINITIONS = Object.freeze({
  ...
  create_wallet: {
    required: ['walletName'],
    optional: ['initialBalance', 'walletType'],
    actionType: 'create_wallet',
    mutates: true,
  },
  rename_wallet: {
    required: ['wallet', 'nextWalletName'],
    optional: [],
  ...
  deposit_goal: {
    required: ['amount', 'goal', 'sourceWallet'],
    optional: [],
    actionType: 'deposit_goal',
    mutates: true,
  },
  withdraw_goal: {
    required: ['amount', 'goal', 'destinationWallet'],
    optional: ['description', 'occurredAt'],

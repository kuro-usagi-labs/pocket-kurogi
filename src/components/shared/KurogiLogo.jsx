export default function KurogiLogo({ size = 64, className = '' }) {
  return (
    <div
      className={`inline-flex shrink-0 items-center justify-center overflow-hidden rounded-full bg-emerald-50 ${className}`}
    ...
    >
      ...
      >
        <circle cx="48" cy="48" r="46" fill="#EEF9F1" />
        ...
        <path d="M36 30C38 18 38 13 36 11" stroke="#16A34A" strokeWidth="3" strokeLinecap="round" />
        <path d="M59 30C57 18 57 13 59 11" stroke="#16A34A" strokeWidth="3" strokeLinecap="round" />
        <path d="M21 80C27 66 36 59 48 59C60 59 69 66 75 80C68 88 59 92 48 92C37 92 28 88 21 80Z" fill="#071427" />
        <path d="M31 73C36 77 41 79 48 79C55 79 60 77 65 73" stroke="#16A34A" strokeWidth="3" strokeLinecap="round" />
        ...
        <circle cx="48" cy="84" r="4" fill="#16A34A" />

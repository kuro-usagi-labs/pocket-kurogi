...
export default function EditTransactionModal({
  ...
  return (
    <div className="fixed inset-0 z-[130] flex items-end justify-center p-3 sm:items-center sm:p-4">
      ...
      <div className="relative z-10 w-full max-w-xl overflow-hidden rounded-[24px] bg-white shadow-2xl animate-scale-in">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <FieldWrap label="Nominal">
                <input
                  ...
                  className="w-full rounded-[16px] border border-midnight/10 bg-champagne px-4 py-3 text-[15px] font-semibold text-midnight outline-none transition-all placeholder:text-muted/50 focus:border-emerald-300 focus:bg-white focus:ring-2 focus:ring-emerald-100"
                />
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <FieldWrap label="Dompet">
                <select
                  ...
                  className="w-full rounded-[16px] border border-midnight/10 bg-champagne px-4 py-3 text-[15px] font-semibold text-midnight outline-none transition-all focus:border-emerald-300 focus:bg-white focus:ring-2 focus:ring-emerald-100"
                >
                  {wallets.map((wallet) => (
